...
## edades
par(mfrow=c(1,2))
hist(tiempo_medio_h$death_time,xlab = "tiempo de muerte\n para hombres",main="",ylab="Frecuencia",ylim=c(0,300),las=2,col="red")
hist(tiempo_medio_m$death_time,xlab = "tiempo de muerte\n para mujeres",main="",ylab="Frecuencia",ylim=c(0,300),las=2,col="blue")

## causas de muerte
tiempo_medio_h$mm16 = as.factor(tiempo_medio_h$mm16)
tiempo_medio_m$mm16 = as.factor(tiempo_medio_m$mm16)
tiempo_medio_h$mm16 %>% table() %>% barplot(las = 1,xlab="Causas de muerte\n para hombres",ylab="Frecuencia",col="red")
tiempo_medio_m$mm16 %>% table() %>% barplot(las = 1,xlab="Causas de muerte\n para mujeres",ylab="Frecuencia",ylim=c(0,400),col="blue")
